...
public class Jobseekers
{
  ...
  public Jobseekers() { this.jobseekers = Collections.emptyList(); }
  public Jobseekers(Collection<Jobseeker> newJobseekers) { jobseekers = newJobseekers; }

  public Jobseekers addNewJobseeker(Jobseeker newJobseeker) {
